...
<xsl:stylesheet 
  ...
  <!-- Custom titlepage for the M2-AMI -->
  <xsl:template name="book.titlepage.recto">
    <!-- M2-AMI -->
    <fo:block-container absolute-position="absolute" top="0mm" left="0mm">
      <fo:block>
        <fo:external-graphic 
              src="img/logos/unicaen.png" 
              content-width="2.5cm" 
              content-type="content-type:image/png" />
      </fo:block>
      <fo:block font-family="serif" font-size="12pt">Département d'informatique</fo:block>
      <fo:block font-family="serif" font-size="12pt" space-before="0pt">Campus Côte de Nacre</fo:block>
      <fo:block font-family="serif" font-size="12pt" space-before="0pt">Bd Maréchal Juin</fo:block>
      <fo:block font-family="serif" font-size="12pt" space-before="0pt">BP 5186</fo:block>
      <fo:block font-family="serif" font-size="12pt" space-before="0pt">F-14032 Caen Cedex</fo:block>
    </fo:block-container>
    ...
    <fo:block-container absolute-position="absolute" top="0mm" right="0mm">
      <fo:block text-align="right">
        <fo:external-graphic 
              src="img/logos/opentrust.png" 
              content-width="7cm" 
              content-type="content-type:image/png" />
      </fo:block>
      <fo:block text-align="right" font-family="serif" font-size="12pt">OpenTrust</fo:block>
      ...
      <fo:block text-align="right" font-family="serif" font-size="12pt">http://www.opentrust.com/</fo:block>
    </fo:block-container>
    
    <!-- Title -->
    <fo:block-container absolute-position="absolute" top="6cm" bottom="2cm" left="0mm" right="0cm" display-align="center">
    ...
    <fo:block-container absolute-position="absolute" bottom="0mm" left="0mm" display-align="after">
      <fo:block font-family="serif" font-size="14pt">Suivi Université:</fo:block>
